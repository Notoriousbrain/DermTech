...
const UserRegister = ({ setAllow }) => {
  ...
  return (
    <div className="h-screen md:h-full bg-my-light dark:bg-my-dark flex flex-col items-center">
      <div className="h-full md:mt-16 flex flex-col justify-center w-1/2 lgm:w-3/5 md:w-4/5 sm:w-4/5">

      ...
      <div className="h-full flex flex-col justify-center w-3/5 lgm:w-4/5 md:w-4/5 sm:w-4/5">
        ...
        <div className="w-full mt-10">
          <div>
            <input
            disabled={!allow}
              className={`dark:bg-my-black-1 bg-my-light border dark:border-my-black-1 border-my-gray-2 w-full outline-none font-poppins dark:text-my-light text-my-gray-2 text-base px-4 py-3 ${!allow ? "cursor-not-allowed" : "cursor-auto"}`}
              placeholder="Write the disease name and press enter"
              value={inputValue}
              onChange={handleInputChange}
              onKeyPress={handleInputKeyPress}
            />
            <p className="text-sm text-my-gray-2">Note: If you don't have any health issue just click next</p>
          </div>
